...
router.get("/incomes", async function (req, res) {
  ...
  let countAmountProductSellingToday =
    await shopModel.countAmountProductSellingToday(+shopId.maso, today);
...
router.get("/bills", async function (req, res) {
  ...
  let getInfoBillByOffset = await shopModel.getInfoBillByOffset(
    shopId.maso,
    offset
  );
  ...
  let getConfirmBillByOffset = await shopModel.getInfoBillByStatus(
    shopId.maso,
    1,
    offsetC
  );
  getConfirmBillByOffset = await shopModel.addStatusFinished(
    getConfirmBillByOffset
  );
  getConfirmBillByOffset = await shopModel.addDateModified(
    getConfirmBillByOffset
  );
  ...
  let getTravellingBillByOffset = await shopModel.getInfoBillByStatusOffset(
    shopId.maso,
    2,
    offsetT
  );
  getTravellingBillByOffset = await shopModel.addStatusFinished(
    getTravellingBillByOffset
  );
  getTravellingBillByOffset = await shopModel.addDateModified(
    getTravellingBillByOffset
  );
  ...
  let getTravelledBillByOffset = await shopModel.getInfoBillByStatusOffset(
    shopId.maso,
    3,
    offsetTe
  );
  getTravelledBillByOffset = await shopModel.addStatusFinished(
    getTravelledBillByOffset
  );
  getTravelledBillByOffset = await shopModel.addDateModified(
    getTravelledBillByOffset
  );
  //getDiscardBill
  ...
  let getDiscardBillByOffset = await shopModel.getInfoBillByStatusOffset(
    shopId.maso,
    4,
    offsetD
  );
  getDiscardBillByOffset = await shopModel.addStatusFinished(
    getDiscardBillByOffset
  );
  getDiscardBillByOffset = await shopModel.addDateModified(
    getDiscardBillByOffset
  );
